			...
			<div class="row">
				<div class="col-sm-12">
					...
					<h2 class="title text-center"
						style="margin-bottom: 80px; font-size: 45px; font-family: 'Noto Sans KR', sans-serif;">PROFILE</h2>
				...
				<div class="contact-form">
					...
					<form>
						<div class="form-group col-md-12">
							...
							<input type="text" readonly="readonly" name="user_id"
						...
						<div class="form-group col-md-12">
							<p id="customerEmail"
								style="float: left; font-family: 'Noto Sans KR', sans-serif; margin-top: 6px;">휴대전화</p>
							<input type="text" name="subject" readonly="readonly"
								class="form-control" required="required"
			...
			<div id="col-sm-4">
				...
				<ul>
					<li style="margin-left: -38px;"><a href="account.do?user_id=${sessionScope.login }" 
						...
						style="font-family: 'Noto Sans KR', sans-serif;">로그아웃</a><br /> <br />
						<br /></li>
