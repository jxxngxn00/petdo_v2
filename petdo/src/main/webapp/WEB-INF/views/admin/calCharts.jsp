...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="calCharts.do"> <i class="fas fa-fw fa-chart-area"></i> <span>정산관리</span></a>
			</li>
			...
			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link" href="comm.do"> <i
					class="fas fa-fw fa-table"></i> <span>광고관리</span></a></li>

			<li class="nav-item"><a class="nav-link" href="orderList.do">
						...
						<div class="card-body">
							<div class="chart-area">
								<c:forEach items="${listCal2}" var="cal2">
									<input type="hidden" name="mSum" value="${cal2.MSUM}"
										class="mSum" />
									<input type="hidden" name="order_date_m"
										value="${cal2.ORDER_DATE_M}" class="order_date_m" />
								</c:forEach>
